...
def create_model_fn(detection_model_fn, configs, hparams, use_amp, use_tpu=False):
  ...
  def model_fn(features, labels, mode, params=None):
    ...
    if mode in (tf.estimator.ModeKeys.TRAIN, tf.estimator.ModeKeys.EVAL):
      ...
      if use_amp:
          ...
          training_optimizer = tf.train.experimental.MixedPrecisionLossScaleOptimizer(
             training_optimizer,
             loss_scale,
          )
...
def create_estimator_and_inputs(run_config,
  ...
  model_fn = model_fn_creator(detection_model_fn, configs, hparams, use_amp, use_tpu)
